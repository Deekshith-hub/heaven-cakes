export default function Footer() {
  return (
    <footer className="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-700 pt-16 pb-12 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <a 
              ...
              className="mt-6 flex items-center gap-2 text-[#43766C] font-bold hover:text-[#B19470] transition-colors bg-[#F8FAE5] dark:bg-slate-800 px-4 py-2 rounded-full text-sm"
            >
          ...
          {/* Contact Section */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h3 className="text-[#1A202C] dark:text-gray-100 font-bold uppercase tracking-widest text-xs mb-6 border-b-2 border-[#B19470] pb-2 inline-block">
              Contact Us
            </h3>
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                ...
                <div className="flex flex-col">
                    <a href="tel:8550082852" className="text-gray-600 dark:text-gray-300 hover:text-[#43766C] transition font-medium">8550082852</a>
                    <a href="tel:9731142825" className="text-gray-600 dark:text-gray-300 hover:text-[#43766C] transition font-medium">9731142825</a>
